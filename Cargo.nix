    ...
    crates = {
      ...
      "k8s-version" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "191c68a277bba250d6a150fa36b796555e8fd8cc";
          sha256 = "1n37g6byyi9kkhrsw6g3dy0b5l5xidn7q3h2ypj92qcagz6vgs43";
        };
        libName = "k8s_version";
        authors = [
        ...
        resolvedDefaultFeatures = [ "darling" "serde" ];
      };
      "kube" = rec {
        crateName = "kube";
        version = "1.1.0";
      ...
      "stackable-versioned" = rec {
        ...
        features = {
          "full" = [ "k8s" ];
          "k8s" = [ "stackable-versioned-macros/k8s" "dep:k8s-version" "dep:schemars" "dep:serde_json" "dep:serde_yaml" "dep:serde" "dep:snafu" ];
        };
